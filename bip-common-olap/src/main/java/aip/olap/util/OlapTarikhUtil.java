...
public class OlapTarikhUtil {
	public static String cnvTarikhAzTa2TarikhOptimizeSet(String dimTarikhName,String tarikhAzStr,String tarikhTaStr){
		aip.olap.TarikSplited tarikhAz = getTarikSplited(tarikhAzStr);
		aip.olap.TarikSplited tarikhTa = getTarikSplited(tarikhTaStr);
	...
	private static String getSemester(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
	 ...
	 */
	private static void increaseToLastYearStart(aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	 ...
	 */
	private static String getYearsToLastYear(String dimTarikhName, aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static void increaseToNextYearStart(aip.olap.TarikSplited tarikhAz) {
		tarikhAz.year++;
		tarikhAz.month=1;
		tarikhAz.day=1;
	}
	...
	private static String getSemesterToYearEnd(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
	 ...
	 */
	private static boolean fillRanesInSeason(String dimTarikhName, List ranges, aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static boolean fillRanesInSemester(String dimTarikhName, List ranges, aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static boolean fillRanesInYear(String dimTarikhName, List ranges, aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static String getSeason(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
	...
	private static void increaseToNextSemesterStart(aip.olap.TarikSplited tarikhAz) {
		int monthSemester = tarikhAz.month<7 ? 1 : 2;
		monthSemester++;
		if(monthSemester>2){
			monthSemester=1;
	...
	private static String getSeasonsToSemesterEnd(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
	...
	private static boolean isInDiffSemester(aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static String getMonth(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
		return getTarikh2HierSaalNimsaalFaslMahRooz(dimTarikhName, tarikhAz.year, tarikhAz.month,0);
	}



	private static boolean isInDiffSeason(aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
		return getMonthSeason(tarikhAz.month)!=getMonthSeason(tarikhTa.month);
	}



	private static void increaseToNextSeasonStart(aip.olap.TarikSplited tarikhAz) {
		int monthSeason = getMonthSeason(tarikhAz.month);
		monthSeason++;
		if(monthSeason>4){
			monthSeason=1;
	...
	private static String getMonthsToSeasonEnd(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
		int monthSeason = getMonthSeason(tarikhAz.month);
	 ...
	 */
	private static String getStartToEndInMonth(String dimTarikhName, aip.olap.TarikSplited tarikhAz, aip.olap.TarikSplited tarikhTa) {
	...
	private static void increaseToNextMonthStart(aip.olap.TarikSplited tarikhAz) {
		tarikhAz.month++;
	...
	private static String getDaysToMonthEnd(String dimTarikhName, aip.olap.TarikSplited tarikhAz) {
		if(tarikhAz.day==1){
			return getTarikh2HierSaalNimsaalFaslMahRooz(dimTarikhName, tarikhAz.year, tarikhAz.month,0);
		}else{
...
//		return DimTarikhName+".["+param.getTarikhsaal()+"].[1].[1].[1].[1]:"+DimTarikhName+".["+param.getTarikhsaal()+"].[2].[3].[9].[30]";
	...
	private static aip.olap.TarikSplited getTarikSplited(String tarikh){
		aip.olap.TarikSplited result = new TarikSplited();
