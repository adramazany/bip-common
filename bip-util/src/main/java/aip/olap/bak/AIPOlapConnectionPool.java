...
public class AIPOlapConnectionPool implements Runnable {
	...
	public AIPOlapConnectionPool(String driver, String url, String username, String password, int initialConnections,
	...
	public synchronized String toString() {
		String info = "AIPOlapConnectionPool(" + url + "," + username + ")" + ", available=" + availableConnections.size()
