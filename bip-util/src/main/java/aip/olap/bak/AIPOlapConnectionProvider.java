...
public class AIPOlapConnectionProvider implements OlapConnectionProvider
	{
	  ...
	  private static final Log logger = LogFactory.getLog(AIPOlapConnectionProvider.class);
	  private String connectionPath;
	  private String username;
	  private String password;

	  public AIPOlapConnectionProvider()
	  {
	  }
	  ...
	  public OlapConnection createConnection(final String user, final String password) throws SQLException
	  {
	    ...
	    {
	      AIPOlapConnectionProvider.logger.warn("Failed to access the JDNI-System", ne);
...
//	    }
	  ...
	  public boolean equals(final Object o)
	  {
	    ...
	    final AIPOlapConnectionProvider that = (AIPOlapConnectionProvider) o;
