...
public abstract class AIPReportLST {
	...
	protected AIPReportParam param = new AIPReportParam();
	...
	public AIPReportParam getParam() {
		return param;
	}

	public void setParam(AIPReportParam param) {
		this.param = param;
