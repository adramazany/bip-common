...
public class NVL
{
  ...
  public static String getStringContext(Object obj, String fieldName, String defaultValue)
  {
    if (obj != null)
    {
      ...
      try
      {
        res = AIPUtil.invokeMulti(obj, fieldName);
      }
      catch (Exception e)
      {
        e.printStackTrace();
  ...
  public static long getLng(Object obj, long defaultValue, boolean removeNonDigits)
  {
	...
	public static String getTrim(String st){
		if(st!=null){
			st=AIPUtil.replaceAllString(st, " ", "");
			st=AIPUtil.replaceAllString(st, ""+(char)160, "");
		}
		return st;
	}
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("NVL.main()" + (int)getDbl("-1,234,567.08$"));
    System.out.println("NVL.main()" + df.format(getDbl(" - 1,234,567.08$")));
  }
}
