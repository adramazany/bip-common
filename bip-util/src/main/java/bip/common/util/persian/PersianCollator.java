package bip.common.util.persian;
...
{
    /**
     * This string is persian collation rules which is in fact a modification to existing arabic collation rules.
     * Features of these rules are:
     * 1. vav (u0648) is put before heh (u0647)
     * 2. persian yeh (u06cc) is sorted before arabic yeh (0649 and 064a)
     * 3. persian kaf (u06a9) is sorted before arabic kaf
     * 4. persian numerics (06f0..06f9) are sorted after english and before arabic
     * 5. Rial sign (ufdfc) is put in list of currency symbols (see java.text.CollationRules.java) and before asterick
     * 6. hamze on vav is sorted right before vav
     * 7. hamze on yeh is sorted right before yeh
     */
