...
public class AIPSkin extends BodyTagSupport {
	...
	void initAIPSkinTypes(){
		...
		htAIPSkinTypeInfos.put(AIPSkinType.TREE , new AIPSkinTypeInfo(AIPSkinType.TREE , "aip/tag/tree/aipskin_tree.html"));
	...
	AIPSkinTypeInfo getNewAIPSkinTypeInfo(AIPSkinType type){
		...
		switch (type) {
			...
			case TREE : info= new AIPSkinTypeInfo(AIPSkinType.TREE , "aip/tag/tree/aipskin_tree.html");break;
